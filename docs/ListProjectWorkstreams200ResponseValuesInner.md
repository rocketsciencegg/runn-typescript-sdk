# ListProjectWorkstreams200ResponseValuesInner
...
```typescript
import { ListProjectWorkstreams200ResponseValuesInner } from 'runn-typescript-sdk';

const instance: ListProjectWorkstreams200ResponseValuesInner = {
    projectId,
    workstreamId,
    createdAt,
    updatedAt,
