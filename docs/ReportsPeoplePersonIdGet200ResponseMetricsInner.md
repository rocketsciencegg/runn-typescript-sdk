# ReportsPeoplePersonIdGet200ResponseMetricsInner
...
```typescript
import { ReportsPeoplePersonIdGet200ResponseMetricsInner } from 'runn-typescript-sdk';

const instance: ReportsPeoplePersonIdGet200ResponseMetricsInner = {
    startDate,
    endDate,
    revenue,
    projectCosts,
