...
**projectId** | **number** | The project related to this entry | [default to undefined]
**personId** | **number** | The person for this entry | [default to undefined]
...
```typescript
import { ReportsHoursPeople } from 'runn-typescript-sdk';

const instance: ReportsHoursPeople = {
    date,
    roleId,
    projectId,
    personId,
