...
**_options** | [**Array&lt;CustomFieldsSelectPostRequestOptionsInner&gt;**](CustomFieldsSelectPostRequestOptionsInner.md) |  | [default to undefined]
...
```typescript
import { CustomFieldsSelectPostRequest } from 'runn-typescript-sdk';

const instance: CustomFieldsSelectPostRequest = {
    name,
    description,
    model,
    _options,
