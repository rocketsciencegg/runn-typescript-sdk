# PeoplePersonIdTimeOffsHolidaysGet200ResponseValuesInner
...
```typescript
import { PeoplePersonIdTimeOffsHolidaysGet200ResponseValuesInner } from 'runn-typescript-sdk';

const instance: PeoplePersonIdTimeOffsHolidaysGet200ResponseValuesInner = {
    id,
    personId,
    startDate,
    endDate,
