# ListProjectMembers200ResponseValuesInner
...
**isPlaceholder** | **boolean** |  | [default to undefined]
...
```typescript
import { ListProjectMembers200ResponseValuesInner } from 'runn-typescript-sdk';

const instance: ListProjectMembers200ResponseValuesInner = {
    id,
    personId,
    projectId,
    roleId,
